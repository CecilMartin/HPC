...
#pragma omp parallel shared(a, b, nthreads, locka, lockb) private(tid)
  ...
  #pragma omp sections nowait
    {
      //BUG: two sections both lock a and b, thread 1 lock a and thread 2 lock b and they cannot compute the following command and thus can not unlock a or b
      //which makes it into deadlock
      //Solution: just unset the lock right after computation.
    #pragma omp section
      {
