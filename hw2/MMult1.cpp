...
int main(int argc, char** argv) {
  ...
  for (long p = PFIRST; p < PLAST; p += PINC) {
    ...
    double time = t.toc();
    double flops = m*n*2.0*k*NREPEATS/time/1e9; // TODO: calculate from m, n, k, NREPEATS, time
    double bandwidth = sizeof(double)*(m*n*k+m*k+n*k)*NREPEATS/time/1e9; // TODO: calculate from m, n, k, NREPEATS, time
